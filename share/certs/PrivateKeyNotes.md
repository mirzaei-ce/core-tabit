...
unlocked to sign the Tabit-Qt.app bundle.
...
allowing somebody to distribute a Tabit-Qt.app or tabit-qt-setup.exe with a valid
...
that the tabit-qt.exe file inside the installer had not been tampered with.
