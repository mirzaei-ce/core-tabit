...
#include "config/tabit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatTabitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + TabitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatTabitURI(info));
}
