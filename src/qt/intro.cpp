...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/tabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tabit Core"),
     ...
     * override -datadir in the tabit.conf file in the default data directory
     * (to be consistent with tabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
