...
#ifndef TABIT_QT_TABITUNITS_H
#define TABIT_QT_TABITUNITS_H
...
/** Tabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TabitUnits(QObject *parent);

    /** Tabit units.
      @note Source: https://en.tabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TBT,
...
typedef TabitUnits::Unit TabitUnit;

#endif // TABIT_QT_TABITUNITS_H
