...
#if defined(NDEBUG)
# error "Tabit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Tabit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s TBT additional fees, %d delta bytes\n",
