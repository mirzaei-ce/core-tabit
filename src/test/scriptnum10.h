...
#ifndef TABIT_TEST_SCRIPTNUM10_H
#define TABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tabit Core 0.10.0, for cross-comparison.
 */
public:
