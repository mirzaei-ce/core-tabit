...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CTabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CTabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CTabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CTabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CTabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CTabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
