...
This document provides guidelines for internationalization of the Tabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tabit_en.ts` remains unchanged.
