Tabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tabit/files/Tabit/tabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Tabit
...
New/changed settings (command-line or tabit.conf file)
--------------------------------------------------------
