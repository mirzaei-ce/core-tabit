Tabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tabit/files/Tabit/tabit-0.5.4/
...
http://gitorious.org/tabit/tabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Tabit-Qt notifications under Growl 1.3.
Increase required age of Tabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTabit properly when installing Tabit-Qt over it. (Windows)
