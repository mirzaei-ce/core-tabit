Tabit Core version 0.9.2.1 is now available from:

  https://tabit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TBT to 0.01 TBT
...
- Fix "Start tabit on system login"
