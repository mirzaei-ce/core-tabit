Tabit Core version 0.9.4 is now available from:

  https://tabit.org/bin/0.9.4/
...
this update is incompatible with the Tabit system and could lead to consensus
forks.

Tabit Core released binaries from https://tabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tabit/+archive/ubuntu/tabit
- A third-party or self-compiled Tabit Core

upgrade to Tabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
