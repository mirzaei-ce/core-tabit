Download URL: https://sourceforge.net/projects/tabit/files/Tabit/tabit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TBT fee schedule (users still pay 0.01 TBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tabit00 - #tabit99
